...
순수 JSON만 출력 (마크다운 ```json 금지):
{
  ...
  "photoAnalysis": "${hp ? `당신은 시험·과제 분석 전문가입니다. ${first} 학생의 학습물을 보고 아래 형식으로 분석을 작성하세요.\n\n[작성 형식 - 정확히 이 순서, 4~5문장, 250자 내외]\n① 무엇을 시험·학습한 자료인지 (예: 'be동사 의문문과 현재진행형 작문 연습입니다.') - 1문장\n② 잘한 부분/이해한 개념 - 구체적 문법 용어로 (예: '명사+be동사 일치는 안정적으로 처리하고 있습니다.') - 1~2문장\n③ 약한 부분/보강 필요 개념 - 구체적 진단 (예: '복수 주어와 be동사 활용에서 일부 혼동이 보입니다.') - 1~2문장\n④ 격려·응원 한마디 (예: '꾸준한 연습으로 충분히 극복할 수 있는 부분이니 함께 다져나가요.') - 1문장\n\n[🚫 절대 금지 - 한 단어라도 들어가면 안 됨]\n사진, 첨부, 노트, 필기, 문제지, 활동지, 시험지, 과제물, 자료에는, 자료를 보면, 첨부 자료, 첨부된\n빨간, 빨간색, 빨간 펜, 빨간펜, 빨간 원, 빨간색 원, 동그라미, 체크, 체크되어, 표시되어, 표시한, 채점\n복습 흔적, 학습 흔적, 흔적, 표시되어 있, 정리한 흔적, 정리해놓은\n학생이 ~한, 스스로 표시, 스스로 체크, 자기주도\n\n[✅ 좋은 예시 - 자료/표시를 절대 언급하지 않음]\n'be동사 의문문 만들기와 현재진행형 작문을 다룬 학습 내용입니다. 명사 주어와 be동사 일치(He is, They are)는 매우 정확하게 처리하고 있으며 어순 감각이 안정적입니다. 다만 현재진행형 부정문(isn''t/aren''t going to)에서 동사 변환을 놓치는 경우가 보여, 이 부분을 한 번 더 점검하면 완성도가 크게 올라갈 거예요. ${first}의 꾸준한 연습이라면 다음 달에는 분명 완벽하게 익힐 수 있습니다.'\n\n[❌ 나쁜 예시 - 이렇게 쓰면 안 됨]\n'노트 필기에 빨간 펜으로 핵심 내용을 표시하며 복습한 흔적이 보입니다.'\n'사진 속 문제지에는 빨간 원으로 체크된 부분이 있습니다.'\n'학생이 자기주도적으로 표시한 부분을 보면...'\n\n자료의 외관·표시·채점에 대해서는 한 글자도 쓰지 않습니다. 오직 학생이 학습한 '내용'과 '이해도'만 분석하세요.` : ""}",
